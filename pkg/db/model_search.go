...
func (cs *CategorySearch) Apply(query *orm.Query) *orm.Query {
	...
	if cs.BotUserID != nil {
		cs.where(query, Tables.Category.Alias, Columns.Category.BotUserID, cs.BotUserID)
	}
	if cs.StatusID != nil {
...
func (es *ExerciseSearch) Apply(query *orm.Query) *orm.Query {
	...
	if es.BotUserID != nil {
		es.where(query, Tables.Exercise.Alias, Columns.Exercise.BotUserID, es.BotUserID)
	}
	if es.StatusID != nil {
...
func (ts *TrainingSearch) Apply(query *orm.Query) *orm.Query {
	...
	if ts.BotUserID != nil {
		ts.where(query, Tables.Training.Alias, Columns.Training.BotUserID, ts.BotUserID)
	}
	if ts.EndedAt != nil {
...
func (bus *BotUserSearch) Apply(query *orm.Query) *orm.Query {
	if bus == nil {
		return query
	}
	if bus.ID != nil {
		bus.where(query, Tables.BotUser.Alias, Columns.BotUser.ID, bus.ID)
	}
	if bus.TgID != nil {
		bus.where(query, Tables.BotUser.Alias, Columns.BotUser.TgID, bus.TgID)
	}
	if bus.CreatedAt != nil {
		bus.where(query, Tables.BotUser.Alias, Columns.BotUser.CreatedAt, bus.CreatedAt)
	}
	if bus.LastActivityAt != nil {
		bus.where(query, Tables.BotUser.Alias, Columns.BotUser.LastActivityAt, bus.LastActivityAt)
	}
	if bus.StatisticID != nil {
		bus.where(query, Tables.BotUser.Alias, Columns.BotUser.StatisticID, bus.StatisticID)
	}
	if bus.StatusID != nil {
		bus.where(query, Tables.BotUser.Alias, Columns.BotUser.StatusID, bus.StatusID)
	}
	if len(bus.IDs) > 0 {
		Filter{Columns.BotUser.ID, bus.IDs, SearchTypeArray, false}.Apply(query)
	}
...
func (bus *BotUserSearch) Q() applier {
	return func(query *orm.Query) (*orm.Query, error) {
		if bus == nil {
			return query, nil
		}
		return bus.Apply(query), nil
	}
}
